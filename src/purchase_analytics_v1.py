...
#Challenge:
#Given two different files that have information on order history of products
#and the data on the product and department id, the goal is to find the number and frequency 
#of order in each department. 
#
...
#filename1 = '/Users/tamenerdasa/Downloads/Purchase-Analytics-master/order_products.csv'
#filename2 = '/Users/tamenerdasa/Downloads/Purchase-Analytics-master/products.csv'
...
#
#---------------------------------------------------------------
#For sovling this particular problem, I decided to create one common file. 
...
#print(product_dict)
#---------------------------------------------------------------
#For each product id I assigned the corrosponding department id and merged it with product summary list
#that we have in the first section.
#---------------------------------------------------------------
#
dept_id = []
...
#
#-------------------------------------------------------------------------------------
#Once I prepared the data that I needed for my problem, I will do further manipulation. 
...
#I find the number of 'number_of_order' and 'number_of_first_orders' as well as the ratio of the latter two. 
#---------------------------------------------------------------
#
temp1 = []
temp2 = []
...
for n in range(len(temp1)):
    for p in range(n+1, len(temp1)):
        if temp1[n] == temp1[p]:
            ...
            #ratio = int(temp3[n]) or int(temp3[p])/total_order1
