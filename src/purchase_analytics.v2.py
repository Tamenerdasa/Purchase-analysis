...
import csv
#
def csv_to_list(inputfile1,inputfile2):
#
#
...
#
#
def manipulate(product_order_interm1):
#
    temp1 = []
    temp2 = []
    temp3 = []
...
#
    ...
    return main_data_sorted
#
#
inputfile1 = './input/order_products.csv'
inputfile2 = './input/products.csv'
#
#
csv_to_list(inputfile1,inputfile2)
#
#
mapping_dict(products_list,order_products_list)
#
#
manipulate(product_order_interm1)
#
#
